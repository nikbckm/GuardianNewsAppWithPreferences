...
/**
 * Helper methods - basically all from the earthquakeapp and adjusted
 */
public final class QueryUtils {
    ...
    // interesting part begins here - parsing the JSON data from the guardian API request
    private static List<Article> extractFeatureFromJson(String articleJSON) {
        ...
        try {
            ...
            for (int i = 0; i < results.length(); i++) {
                ...
                // I struggled with getting the author from the nested JSONArrays
                // this helped me: https://github.com/laramartin/android_newsfeed
